  ...
  return (
    <header className={`header ${scrolled ? 'header--scrolled' : ''}`}>
      <div className="header__inner container">
        ...
        <button className={`header__hamburger ${menuOpen ? 'header__hamburger--open' : ''}`} onClick={() => setMenuOpen(!menuOpen)}>
          <span /><span /><span />
        </button>
        ...
        <div className="header__actions">
          <Button variant="accent" size="sm" className="btn-animate">
            Sign in
          </Button>
         <Button variant="accent" size="sm" className="btn-animate" onClick={onJoinClick}>
            Join now
          </Button>
        </div>
      </div>
